...
const ContactSection = () => {
  return (
    <section
      id="contact"
      className="py-20 bg-modern-gray/30 dark:bg-designer-secondary/20"
    >
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label
                    htmlFor="name"
                    className="block text-sm font-medium text-designer-secondary/90 dark:text-designer-accent/90"
                  >
                    Имя
                  </label>
                  <Input
            ...
            <div className="mt-10 p-6 bg-white dark:bg-designer-card rounded-lg shadow-md">
              ...
              <ul className="space-y-2">
                <li className="flex justify-between">
                  <span className="text-designer-secondary/70 dark:text-designer-accent/70">
                    Понедельник - Пятница:
                  </span>
                  <span className="text-designer-secondary dark:text-designer-accent font-medium">
                    9:00 - 18:00
                  </span>
                </li>
                <li className="flex justify-between">
