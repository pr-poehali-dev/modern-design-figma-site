      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 py-16">
          ...
          <div className="md:col-span-1 lg:col-span-1">
            <a
              href="#"
              className="text-white font-montserrat font-bold text-xl mb-4 inline-block"
            >
              <span className="text-designer-primary">D</span>esign
              <span className="text-designer-primary">Studio</span>
            </a>
            <p className="text-gray-300 mb-4">
              Создаю уникальные дизайн-решения, которые помогают брендам
              выделяться и достигать своих целей.
            </p>
            <div className="flex space-x-3">
              <a
                href="#"
                className="text-gray-300 hover:text-designer-primary transition-colors"
              >
        ...
        <div className="border-t border-gray-700 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <a
                href="#"
                className="text-gray-400 hover:text-designer-primary text-sm transition-colors"
              >
